      ...
      else 
      {
        ...
        xhr.onreadystatechange = () => { if (xhr.readyState == 4 && xhr.status == 200) 
            { 
                ...
                console.log(m); var x = document.getElementById("data");
                 ...
                 { 
                     ...
                     b.innerHTML = `Confirmed Cases: ${m[i].Confirmed}`;
                      b.style.padding = "6px"; var b1 = document.createElement("p"); 
                      b1.innerHTML = `Active Cases: ${m[i].Active}`; b1.style.padding = "6px"; 
